            ...
            <header className='inset-x-0 top-0 z-50'>
                <nav className='flex items-center justify-between p-4 lg:px-12 border-b border-primary-50' aria-label='Global'>
                    ...
                    <div className='hidden lg:flex lg:gap-x-6'>
                        {navigation.map((item) => (
                            <a key={item.name} href={item.href} className='text-base font-os leading-6 text-black-600'>{item.name}</a>
                        ))}
                    </div>
                        ...
                        <div className='mt-4 flow-root'>
                            <div className='-m-y-6 divide-y divide-gray-500/10'>
                                <div className='space-y-2'>
                                    {navigation.map((item) => (
                                        <a key={item.name} href={item.href} className='-mx-3 block rounded-lg px-7 py-2 text-base font-os leading-7 text-black-600 hover:bg-gray-50'>{item.name}
                                        </a>
                                    ))}
                                </div>
