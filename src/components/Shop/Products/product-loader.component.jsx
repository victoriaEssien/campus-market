...
export const ProdcutLoaderComponent = () => {
    ...
    const template = <div className="w-48 md:w-72 rounded-[10px] hover:bg-accent-200" >
    ...
    return (
        <div className='mx-4 md:mx-14 grid grid-cols-2 md:grid-cols-4 gap-x-5 gap-y-20 w-fit mt-9'>
            { template }
            { template }
            { template }
            { template }
